...
//Questa funzione gestisce i preferiti all'interno di un array
  ...
  return (
   <div className={styles.main}>
     <Nav setPage={setPagina} pagina_attiva={pagina_attiva}/>
     <Lista n_pagine={props.n_pagine} active_page={pagina_attiva} setPreferiti={G_preferiti} preferiti={preferiti} personaggi={props.personaggi}/>   
   </div>
  )
}
